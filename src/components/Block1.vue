            ...
            <div class="radio_block">
              ...
              >
                <input
                  ...
                  :name="$store.state.activeAnswer+'[]'"
                  :id="$store.state.activeAnswer+index"
                  :value="it"
                >
              ...
              <div class="col-lg-6 text-center">
                <div class="inputGroup">
                  <input
                    ...
                    :name="$store.state.activeAnswer"
                    :id="$store.state.activeAnswer+'2'"
                    value="Нет"
                  >
                  <label
                    class="form-check-label"
                    :for="$store.state.activeAnswer+'2'"
              ...
              <div class="col-lg-6 text-center">
                <div class="inputGroup">
                  <input
                    ...
                    :name="$store.state.activeAnswer"
                    :id="$store.state.activeAnswer+'1'"
                    value="Да"
                  >
                  <label
                    class="form-check-label"
                    :for="$store.state.activeAnswer+'1'"
